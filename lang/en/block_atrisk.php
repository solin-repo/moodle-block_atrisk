...
$string['config_skip_ended_courses'] = 'Skip ended courses';
$string['config_skip_ended_courses_desc'] = 'Override the site-level setting for this block. When on, the block shows nothing once the course end date has passed (otherwise every student is flagged for inactivity simply because the course is over). "Force off" keeps flagging students even after the course has ended.';
$string['config_skip_ended_courses_inherit_off'] = 'Inherit site default (currently: off)';
$string['config_skip_ended_courses_inherit_on'] = 'Inherit site default (currently: on)';
$string['config_skip_ended_courses_off'] = 'Force off';
$string['config_skip_ended_courses_on'] = 'Force on';
...
$string['empty_course_ended'] = 'This course has ended, so no students are being monitored. To keep flagging students after the end date, change "Skip ended courses" in the block settings.';
...
$string['settings_skip_ended_courses'] = 'Skip courses that have ended';
$string['settings_skip_ended_courses_desc'] = 'When enabled, the block shows nothing in a course whose end date has passed. This avoids flagging the entire roster for inactivity simply because the course is over. Teachers can override this per block. On by default.';
