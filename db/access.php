...
/**
 * Capability definitions for block_atrisk (Solin Early Warning).
 *
 * Capabilities map to FR-184 (§8 of the functional spec). Defaults follow
 * least privilege: students hold no block_atrisk capability; teachers may
 * view and configure their own blocks; site-wide configuration is
 * manager-only.
 *
